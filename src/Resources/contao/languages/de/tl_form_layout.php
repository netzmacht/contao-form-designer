...
$GLOBALS['TL_LANG']['tl_form_layout']['edit'][0]   = 'Formularlayout bearbeiten';
$GLOBALS['TL_LANG']['tl_form_layout']['edit'][1]   = 'Formularlayout ID "%s" bearbeiten';
$GLOBALS['TL_LANG']['tl_form_layout']['copy'][0]   = 'Formularlayout duplizieren';
$GLOBALS['TL_LANG']['tl_form_layout']['copy'][1]   = 'Formularlayout ID "%s" duplizieren';
$GLOBALS['TL_LANG']['tl_form_layout']['delete'][0] = 'Formularlayout löschen';
$GLOBALS['TL_LANG']['tl_form_layout']['delete'][1] = 'Formularlayout ID "%s" löschen';
$GLOBALS['TL_LANG']['tl_form_layout']['show'][0]   = 'Zeige Details des Formularlayouts';
$GLOBALS['TL_LANG']['tl_form_layout']['show'][1]   = 'Zeige Details des Formularlayouts "%s".';

$GLOBALS['TL_LANG']['tl_form_layout']['title'][0]           = 'Titel';
$GLOBALS['TL_LANG']['tl_form_layout']['title'][1]           = 'Titel des Formularlayouts.';
$GLOBALS['TL_LANG']['tl_form_layout']['type'][0]            = 'Typ';
$GLOBALS['TL_LANG']['tl_form_layout']['type'][1]            = 'Typ des Formularlayouts.';
$GLOBALS['TL_LANG']['tl_form_layout']['defaultLayout'][0]   = 'Standard';
$GLOBALS['TL_LANG']['tl_form_layout']['defaultLayout'][1]   = 'Formularlayout wird als Standard verwendet.';
$GLOBALS['TL_LANG']['tl_form_layout']['widgets'][0]         = 'Widgets';
$GLOBALS['TL_LANG']['tl_form_layout']['widgets'][1]         = 'Konfiguration der Formular-Widgets.';
$GLOBALS['TL_LANG']['tl_form_layout']['widget'][0]          = 'Widget';
$GLOBALS['TL_LANG']['tl_form_layout']['layout'][0]          = 'Layout-Template';
$GLOBALS['TL_LANG']['tl_form_layout']['control'][0]         = 'Element-Template';
